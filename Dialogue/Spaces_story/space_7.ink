...
#speaker: Narrator
{MONSTER_NAME} musters all his strength, letting the air seep deep within, and then unleashes a guttural screech.

Whiskers’ fur is blown back, his claws loosen their grasp, and his body leaps to the ground. He scores a perfect ten point landing into the arms of Ruby!
#speaker: Ruby
Well darn, all I needed was a louder megaphone this whole time! Thanks for your help getting Whiskers down safely. I’ll be sure to tell Whiskers’ owner about the kind strangers who helped me out.
...
{MONSTER_NAME} thinks for a moment then nods with confirmation. You scoop {MONSTER_NAME} up like a football and chuck him at Whiskers. 
...
+[Use {MONSTER_NAME}’s ice beam to put out the fire.]
	...
	#speaker: Ruby
Now that was something to behold, if I had the power to shoot off ice beams from my ears, I’d never retire!

Why don’t you two come on down by the station sometime soon and I’ll give you both a tour. I wouldn’t have been able to put out that fire without the help!
	 ~ change_variable("fear", amount_b*-1)
-> space_7_firetruck_ride
...
#speaker: Ruby
Hey {pc_name}, it’s getting to that time of year where the air is dryer than a bone. Which means everyone has to be aware of what not to do during wildfire season. 

As passionate as I am about fire safety I’ve got a horrendous case of stage fright. Plus Larry isn’t the talkative type. 
...
+[We can’t <i>bear</i> to not help out. We don’t want a <i>smokey</i> town after all.]
#speaker: Narrator
...
#speaker: Ruby
WE’RE GONNA DIE, WE’RE ALL GONNA DIE! SOMEBODY GET THE FLAMETHROWER, I DON’T CARE HOW MUCH DAMAGE WE HAVE TO REPAIR! 

WHAT DO YOU MEAN WE ONLY HAVE WATER????!?! 

I THOUGHT WE WERE THE <i>FIRE</i> DEPARTMENT!!!
#speaker: Narrator
...
#speaker: Ruby
WHEW! I for sure thought the station was a goner. Fires are one thing, <i>but spiders</i>? Absolutely not! That’s why I’m making the executive decision to make you both honorary firefighters. We’ll get you two your helmets pronto!
~ change_variable("fear", amount_b*-1)
-> space_7_firetruck_ride

+[Open Larry’s tank.]
#speaker: Narrator
You and {MONSTER_NAME} look at each other and then back at the scene. The only calm being here is Larry in his tank.

{MONSTER_NAME} goes over to the tank and lets Larry out. They wander out and begins to crawl towards the spider at a breakneck speed of an uninterested reptile. 
...
Deciding you’d rather not be a part of the clean up you and {MONSTER_NAME} leave the station, hoping never to encounter another spider there ever again.
~ change_variable("fear", amount_b*-1)
-> space_7_firetruck_ride
