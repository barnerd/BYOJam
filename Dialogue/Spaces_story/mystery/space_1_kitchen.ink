...
{visited_kitchen == false:
    ...
    <i>You and Lotta Scoops head to the kitchen. The family spends a lot of time here, so it's possible there may be some clues here to the bug's origin.</i>
}
...
"What's this on the table... blood?"
