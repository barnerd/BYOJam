...
{not space_6_interaction_7: -> space_6_interaction_7}
{not space_6_interaction_8: -> space_6_interaction_8}


+[choice one] -> space_6_interaction_1
+[choice two] ->space_6_interaction_2
+[choice three] ->space_6_interaction_3
+[choice four] ->space_6_interaction_4
+[choice five] ->space_6_interaction_5
+[choice six] ->space_6_interaction_6
+[choice seven] ->space_6_interaction_7
+[choice eight]->space_6_interaction_8
...
#speaker:Ruby
Ruby: “Well darn, all I needed was a louder megaphone this whole time! Thanks for your help getting Whiskers down safely. I’ll be sure to tell Whiskers’ owner about the kind strangers who help me out.”
///~ change_variable("fear”, Bagel)
->DONE
+[Chuck your pet at the cat.]
#speaker:Narrator
	You gaze deep into {MONSTER_NAME}’s eyes. You ask: Do you trust me? {MONSTER_NAME} thinks for a moment then nods with confirmation. You scoop {MONSTER_NAME} up like a football and chuck him at Whiskers. In a flash Whiskers eyes are greeted with the sight of something they’ve never witnessed before and loosens their grasp on the tree branch. Whiskers leaps into one of Ruby’s hands, and the other hand catches {MONSTER_NAME} as well.
	#speaker:Ruby
Ruby: “A bit unorthodox if I say so myself, but hey it worked! Good thing I played football back in highschool. Here’s your uh, pet, back. Thanks for the help, I gotta tell the squad down at the station about this one, hahahaa!”
///~ change_variable("fear”, Bagel)
->DONE
...
#speaker:Ruby
	Ruby: "Hey friends, happy to see you two again! Would you mind joining me for this wellness check? Old dog Barkson enjoys having fun visitors, and I forgot to bring the squad’s emotional support iguana, Larry, with me. Plus Barkson likes giving away his spare change, so your good deed won’t go unrewarded. What do you say?"
...
While passing the fire station you see Ruby outside in the yard with a group of pups.
	#speaker:Ruby
Ruby: Now remember, smoke rises up so you have to get down low and crawl out. Because if you breathe smoke it's real icky and deadly. Now can anyone tell me what to do if your clothes catch on fire?
+[ “Stop, ‘Play Dead’, and Roll!”]
	#speaker:Ruby
	Ruby: “That’s right! Could you demonstrate for all these pups what that looks like?"
	#speaker:Narrator
...
==space_6_interaction_4==
	#speaker:Narrator
Sirens and lights are going off in a flurry as the firetruck stops across the street from you and {MONSTER_NAME}. Looking over, you see one of the local stores ablaze. Ruby and her squad are already on the scene, attaching the hose to a fire hydrant and busting into the store to get everyone out. But for some reason the water isn’t coming out of the hose. That’s when you spot that in all the panic, a passing car ran over the hose and tore open a hole. 
+[Use {MONSTER_NAME}’s saliva to patch up the hose.]
	#speaker:Ruby
	Ruby: "Thank you both! Come by the station sometime soon and I’ll be sure to give you two a tour! I wouldn’t have been able to put out that fire without your help!"
///~ change_variable("fear”, Bagel)
->DONE

+[Use {MONSTER_NAME}’s ice beam to put out the fire.]
	#speaker:Ruby
	Ruby: "Now that was something to behold! If I had the power to shoot off ice beams from my ears, I’d never retire. Why don’t you two come on down by the station sometime soon and I’ll give you both a tour! I wouldn’t have been able to put out that fire without the help!"
	 ///~ change_variable("fear”, Bagel)
->DONE
...
Ruby invites you into the station for a tour, and everybody is delighted to see you here. There’s a banner with {MONSTER_NAME}’s name, a cake, and streamers galore.  
	#speaker:Ruby
Ruby: "Everybody was so impressed by your quick thinking at that fire, that we decided to celebrate and make {MONSTER_NAME} our station’s new mascot. What do you say?"
+[“Count me in!”]
#speaker:Ruby
	Ruby: "Hooray! Make room Larry, there’s a new member on the squad!"
	#speaker:Narrator
...
#speaker:Ruby
Ruby: "Hey (player), it’s getting to that time of year where the air is dryer than a bone, which means everyone has to be aware of what not to do during wildfire season. As passionate as I am about fire safety I’ve got a horrendous case of stage fright. Plus Larry isn’t the talkative type. Would you and {MONSTER_NAME} be willing to give the town a Fire Safety PSA tonight? Remind them that only they can help prevent wildfires."
...
#speaker:Ruby
Ruby: "WE’RE GONNA DIE, WE’RE ALL GONNA DIE! SOMEBODY GET THE FLAMETHROWER, I DON’T CARE HOW MUCH DAMAGE WE HAVE TO REPAIR! WHAT DO YOU MEAN WE ONLY HAVE WATER????!?! I THOUGHT WE WERE THE FIRE DEPARTMENT!!!"
#speaker:Narrator
...
#speaker:Ruby
Ruby: "WHEW! I for sure thought the station was a goner. Fires are one thing, but spiders? Absolutely not. That’s why I’m making the executive decision to make you both honorary firefighters! We’ll get you your helmets pronto!"
///~ change_variable("fear”, Bagel)
->DONE
+[Open Larry’s tank.]
#speaker:Narrator
...
#speaker:Ruby
Ruby: "By Doggy I thought the station was a goner! I’m glad to see we still had someone with enough courage here. I’m repromoting you to the station mascot Larry, here’s your fire helmet back!"
#speaker:Narrator
