...
~ get_variable("number_of_spaces_destroyed")
{number_of_spaces_destroyed > 2:
    +[Uh... nope! <i>(moderately guilty)</i>]
    
    Well what's been <i>bugging</i> me is that at every scene where the monster's been it's reported that they aren't alone. That they have an accomplice or a handler of some kind. 
    
    That's odd, isn't it? Can you imagine a little girl or something like that teaming up with a scary, life ruining monster?
    
    I can't! Anyways be on the look out you two, and stay safe, I thought I saw you both near one of those collapsed buildings. That isn't a playground. 
    
    Well, as you two were.
    ~ change_variable("fear", amount_b*-1)
    ->DONE
}
